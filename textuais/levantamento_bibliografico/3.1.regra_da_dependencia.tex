\subsection{Regra da dependência}
    ...
    As regras de negócio (Business Rules) não interagem diretamente com os detalhes de implementação, mas sim interfaces, que são como um plug-in, que não fica acoplado ao núcleo do software, assim possibilitando a troca do BD ou da UI gráfica.
