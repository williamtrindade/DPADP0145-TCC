...
\subsection{Princípio da Responsabilidade Única (Single Responsibility Principle - SRP)}
   ...
   \begin{figure}[H]
    ...
    \par Na Figura~\ref{fig:figura_srp_good} a classe User mantém apenas os dados, a classe UserRepository controla a persistência e AuthService gerenciaria a autenticação, assim demonstrando o uso da SRP, onde cada classe tem sua própria responsabilidade \cite{artigo:ramachandrappa:2024}.
