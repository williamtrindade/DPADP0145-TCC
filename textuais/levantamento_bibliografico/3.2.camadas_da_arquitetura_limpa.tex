\subsection{Camadas da Arquitetura Limpa}
    ...
    \par Para representar os princípios de separação de interesse e independência de detalhes, \cite{livro:martin:cleanarch} propõe um modelo visual para a Arquitetura Limpa, que pode ser visto na Figura \ref{fig:figura_clean_arch_1}.
    ...
    \begin{itemize}
        ...
        \item Frameworks e Drivers: Os \textit{frameworks} e \textit{drivers} representam as ferramentas e tecnologias externas, como bancos de dados, \textit{frameworks} e dispositivos que fazem entrada ou saída de dados, considerados detalhes de implementação que podem mudar ao longo do tempo de desenvolvimento dos projetos \cite{livro:martin:cleanarch}.
    \end{itemize}