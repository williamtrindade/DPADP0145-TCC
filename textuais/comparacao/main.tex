...
\thispagestyle{headings}
    ...
    \input{textuais/comparacao/estrutural}

    \input{textuais/comparacao/fluxo}
    ...
    \par O resultado é que o padrão MVC passou a operar estritamente como a camada de interação externa, adaptando as entradas e saídas (com o auxílio do Presenter e ViewModel para a View JSON), enquanto o núcleo de negócio permanece completamente isolado e agnóstico ao \textit{framework}.