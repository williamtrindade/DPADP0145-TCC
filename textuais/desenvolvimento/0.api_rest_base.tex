\section {API REST base}
    ...
    \subsection{Docker}
        ...
        \begin{sloppypar}
            \par No Código \ref{lst:.env.example} é apresentado como ficou parcialmente o arquivo \texttt{.env.example}, com as mudanças que são necessárias para o funcionamento da API REST, tal arquivo vai para o sistema controle de versão:
        \end{sloppypar}
    ...
    \subsection{Codificação da API REST}
        ...
        \par Conforme mostra o Código~\ref{lst:mvc-model-0}, o arquivo referente ao Model apresenta a seguinte implementação:
